SET ECHO ON
SPOOL "C:\Users\ASUS\OneDrive\Documents\SAIT\Courses\CPRG-250-SA1\Week 14\Project\Project\Build\TimberScript.txt"
...
CREATE TABLE TB_Product_Review(
    ...
    customer_number VARCHAR2(60) CONSTRAINT SYS_TB_Customer_Fk REFERENCES TB_Customer(customer_number),
...
CREATE TABLE TB_Product_Manifest(
    ...
    CONSTRAINT SYS_TB_Category_ProductManifest_FK FOREIGN KEY(product_number) REFERENCES TB_Product(product_number)
);
